...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
[_BL] = KEYMAP(
  KC_GESC,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_GRV, KC_BSLS,        KC_WREF, \
...
[_NR] = KEYMAP(
   ...
   */
[_FL] = KEYMAP(
  xxxxxxx,  KC_F1,  KC_F2,  KC_F3,  KC_F4, BL_DEC, BL_INC,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10, KC_F11, KC_F12,        TG(_CL), \
